...
@Component({
  selector: 'app-vfeed',
  templateUrl: './vfeed.component.html',
  styleUrls: ['./vfeed.component.scss']
})
export class VfeedComponent implements OnInit {
  newsdetails:any =[];
  alert: boolean = false;

  displayedColumns=['Student Name','Department','Feedback Title','Feedback Desc']
  dataSource:any=[
